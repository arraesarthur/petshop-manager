...
function NativeSelect({
  ...
  return (
    <div
      className={cn(
        "group/native-select relative w-fit has-[select:disabled]:opacity-50 rounded-b-md",
        className
      )}
...
function NativeSelectOption({
  ...
  return (
    <option
      ...
      className={cn("bg-background text-gray-600", className)}
      {...props}
    />
  )
}
